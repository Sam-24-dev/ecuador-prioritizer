...
export function AnalizarPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl">
      ...
      <Card className="mt-10">
        ...
        <CardContent className="space-y-6 pt-5 sm:pt-7">
          <div className="flex flex-wrap items-center gap-3 border-b border-border pb-5">
            ...
            <Button type="button" variant="outline" onClick={() => setUrlImportOpen(true)}><Link2 className="h-4 w-4" aria-hidden="true" />Importar desde URL</Button>
      ...
      <UrlImportDialog isOpen={urlImportOpen} isLotFull={items.length >= MAX_NEWS_ITEMS} onClose={() => setUrlImportOpen(false)} onConfirm={handleUrlPreviewConfirmed} />
    </div>
  );
}
