...
export function AnalizarPage() {
  ...
  const confirmPreview = () => {
    ...
    setPreview([]);
    setPreviewTitle('Pega varias noticias');
  ...
  return (
    <div className="mx-auto max-w-5xl">
      ...
      <Card className="mt-10">
        ...
        <CardContent className="space-y-6 pt-5 sm:pt-7">
          <div className="flex flex-wrap items-center gap-3 border-b border-border pb-5">
            ...
            <Button ref={pasteTriggerRef} type="button" variant="outline" onClick={() => { setPasteFeedback(''); if (!preview.length || previewTitle !== 'Revisa las noticias pegadas') { setPreview([]); setPreviewTitle('Pega varias noticias'); } setPreviewOpen(true); }}><ClipboardPaste className="h-4 w-4" aria-hidden="true" />Pegar varias noticias</Button>
      ...
      <p className="mt-5 border-l-2 border-terracotta bg-muted px-3 py-2 text-sm leading-relaxed text-muted-foreground">Antes de analizar, la herramienta envía el texto de la noticia y, si los agregas, su fuente o enlace para ordenar qué noticias conviene revisar primero. No necesitas crear una cuenta. No envíes información sensible. <a className="font-medium text-primary underline underline-offset-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" href="/transparencia">Cómo se usa tu información</a></p>
